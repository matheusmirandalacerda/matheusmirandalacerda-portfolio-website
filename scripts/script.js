...
function manipularEventos() {
    ...
    const paragrafo = document.querySelector("#nome-perfil");
...
const campoTelefone = document.getElementById('input-telefone');
...
function enviarParaWhatsApp() {
    ...
    const numeroWhatsApp = '5581999990763'; // Insira o número de telefone do WhatsApp aqui (apenas números)
